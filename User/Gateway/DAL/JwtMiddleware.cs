...
namespace BanMayTinh_Gateway
{
    public class JwtMiddleware
    {
        ...
        private IDatabaseHelper db = null;
        public JwtMiddleware(RequestDelegate next, IOptions<AppSettings> appSettings, IDatabaseHelper _db)
        {
            _next = next;
        ...
        public async Task GenerateToken(HttpContext context)
        {
            ...
            var query = from n in db.Users
                        join t in db.Accounts on n.MaNguoiDung equals t.MaNguoiDung
                        select new
                        {
